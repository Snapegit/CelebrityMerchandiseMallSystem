...
-- Records of address
-- ----------------------------
INSERT INTO `address` VALUES (1, '2024-03-24 13:38:01', 11, '宇宙银河系金星1号', '金某', '13823888881', '是');
INSERT INTO `address` VALUES (2, '2024-03-24 13:38:01', 12, '宇宙银河系木星1号', '木某', '13823888882', '是');
INSERT INTO `address` VALUES (3, '2024-03-24 13:38:01', 13, '宇宙银河系水星1号', '水某', '13823888883', '是');
INSERT INTO `address` VALUES (4, '2024-03-24 13:38:01', 14, '宇宙银河系火星1号', '火某', '13823888884', '是');
INSERT INTO `address` VALUES (5, '2024-03-24 13:38:01', 15, '宇宙银河系土星1号', '土某', '13823888885', '是');
INSERT INTO `address` VALUES (6, '2024-03-24 13:38:01', 16, '宇宙银河系月球1号', '月某', '13823888886', '是');
INSERT INTO `address` VALUES (7, '2024-03-24 13:38:01', 17, '宇宙银河系黑洞1号', '黑某', '13823888887', '是');
INSERT INTO `address` VALUES (8, '2024-03-24 13:38:01', 18, '宇宙银河系地球1号', '地某', '13823888888', '是');
...
CREATE TABLE `cart`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `tablename` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT 'shangpinxinxi' COMMENT '周边表名',
  `userid` bigint NOT NULL COMMENT '用户id',
  `goodid` bigint NOT NULL COMMENT '周边id',
  `goodname` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '周边名称',
...
CREATE TABLE `chat`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 59 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '在线客服' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of chat
-- ----------------------------
INSERT INTO `chat` VALUES (51, '2024-03-24 13:38:01', 1, 1, '提问1', '回复1', 1);
INSERT INTO `chat` VALUES (52, '2024-03-24 13:38:01', 2, 2, '提问2', '回复2', 2);
INSERT INTO `chat` VALUES (53, '2024-03-24 13:38:01', 3, 3, '提问3', '回复3', 3);
INSERT INTO `chat` VALUES (54, '2024-03-24 13:38:01', 4, 4, '提问4', '回复4', 4);
INSERT INTO `chat` VALUES (55, '2024-03-24 13:38:01', 5, 5, '提问5', '回复5', 5);
INSERT INTO `chat` VALUES (56, '2024-03-24 13:38:01', 6, 6, '提问6', '回复6', 6);
INSERT INTO `chat` VALUES (57, '2024-03-24 13:38:01', 7, 7, '提问7', '回复7', 7);
INSERT INTO `chat` VALUES (58, '2024-03-24 13:38:01', 8, 8, '提问8', '回复8', 8);
...
CREATE TABLE `discussshangpinxinxi`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '周边信息评论表' ROW_FORMAT = Dynamic;
...
-- Records of forum
-- ----------------------------
INSERT INTO `forum` VALUES (61, '2024-03-24 13:38:01', '帖子标题1', '帖子内容1', 0, 1, '用户名1', 'upload/forum_avatarurl1.jpg,upload/forum_avatarurl2.jpg,upload/forum_avatarurl3.jpg', '开放', 0, '2024-03-24 13:38:01');
INSERT INTO `forum` VALUES (62, '2024-03-24 13:38:01', '帖子标题2', '帖子内容2', 0, 2, '用户名2', 'upload/forum_avatarurl2.jpg,upload/forum_avatarurl3.jpg,upload/forum_avatarurl4.jpg', '开放', 0, '2024-03-24 13:38:01');
INSERT INTO `forum` VALUES (63, '2024-03-24 13:38:01', '帖子标题3', '帖子内容3', 0, 3, '用户名3', 'upload/forum_avatarurl3.jpg,upload/forum_avatarurl4.jpg,upload/forum_avatarurl5.jpg', '开放', 0, '2024-03-24 13:38:01');
INSERT INTO `forum` VALUES (64, '2024-03-24 13:38:01', '帖子标题4', '帖子内容4', 0, 4, '用户名4', 'upload/forum_avatarurl4.jpg,upload/forum_avatarurl5.jpg,upload/forum_avatarurl6.jpg', '开放', 0, '2024-03-24 13:38:01');
INSERT INTO `forum` VALUES (65, '2024-03-24 13:38:01', '帖子标题5', '帖子内容5', 0, 5, '用户名5', 'upload/forum_avatarurl5.jpg,upload/forum_avatarurl6.jpg,upload/forum_avatarurl7.jpg', '开放', 0, '2024-03-24 13:38:01');
INSERT INTO `forum` VALUES (66, '2024-03-24 13:38:01', '帖子标题6', '帖子内容6', 0, 6, '用户名6', 'upload/forum_avatarurl6.jpg,upload/forum_avatarurl7.jpg,upload/forum_avatarurl8.jpg', '开放', 0, '2024-03-24 13:38:01');
INSERT INTO `forum` VALUES (67, '2024-03-24 13:38:01', '帖子标题7', '帖子内容7', 0, 7, '用户名7', 'upload/forum_avatarurl7.jpg,upload/forum_avatarurl8.jpg,upload/forum_avatarurl9.jpg', '开放', 0, '2024-03-24 13:38:01');
INSERT INTO `forum` VALUES (68, '2024-03-24 13:38:01', '帖子标题8', '帖子内容8', 0, 8, '用户名8', 'upload/forum_avatarurl8.jpg,upload/forum_avatarurl9.jpg,upload/forum_avatarurl10.jpg', '开放', 0, '2024-03-24 13:38:01');
...
-- Records of newstype
-- ----------------------------
INSERT INTO `newstype` VALUES (101, '2024-03-24 13:38:01', '分类名称1');
INSERT INTO `newstype` VALUES (102, '2024-03-24 13:38:01', '分类名称2');
INSERT INTO `newstype` VALUES (103, '2024-03-24 13:38:01', '分类名称3');
INSERT INTO `newstype` VALUES (104, '2024-03-24 13:38:01', '分类名称4');
INSERT INTO `newstype` VALUES (105, '2024-03-24 13:38:01', '分类名称5');
INSERT INTO `newstype` VALUES (106, '2024-03-24 13:38:01', '分类名称6');
INSERT INTO `newstype` VALUES (107, '2024-03-24 13:38:01', '分类名称7');
INSERT INTO `newstype` VALUES (108, '2024-03-24 13:38:01', '分类名称8');
...
CREATE TABLE `orders`  (
  ...
  `goodid` bigint NOT NULL COMMENT '周边id',
  `goodname` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '周边名称',
  `picture` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '周边图片',
  `buynumber` int NOT NULL COMMENT '购买数量',
...
-- Records of shangjia
-- ----------------------------
INSERT INTO `shangjia` VALUES (21, '2024-03-24 13:38:01', '商家号1', '123456', '商家名称1', '商家地址1', '13823888881', '773890001@qq.com', '', 'upload/shangjia_shangpuzhaopian1.jpg', '商家介绍1', 200);
INSERT INTO `shangjia` VALUES (22, '2024-03-24 13:38:01', '商家号2', '123456', '商家名称2', '商家地址2', '13823888882', '773890002@qq.com', '', 'upload/shangjia_shangpuzhaopian2.jpg', '商家介绍2', 200);
INSERT INTO `shangjia` VALUES (23, '2024-03-24 13:38:01', '商家号3', '123456', '商家名称3', '商家地址3', '13823888883', '773890003@qq.com', '', 'upload/shangjia_shangpuzhaopian3.jpg', '商家介绍3', 200);
INSERT INTO `shangjia` VALUES (24, '2024-03-24 13:38:01', '商家号4', '123456', '商家名称4', '商家地址4', '13823888884', '773890004@qq.com', '', 'upload/shangjia_shangpuzhaopian4.jpg', '商家介绍4', 200);
INSERT INTO `shangjia` VALUES (25, '2024-03-24 13:38:01', '商家号5', '123456', '商家名称5', '商家地址5', '13823888885', '773890005@qq.com', '', 'upload/shangjia_shangpuzhaopian5.jpg', '商家介绍5', 200);
INSERT INTO `shangjia` VALUES (26, '2024-03-24 13:38:01', '商家号6', '123456', '商家名称6', '商家地址6', '13823888886', '773890006@qq.com', '', 'upload/shangjia_shangpuzhaopian6.jpg', '商家介绍6', 200);
INSERT INTO `shangjia` VALUES (27, '2024-03-24 13:38:01', '商家号7', '123456', '商家名称7', '商家地址7', '13823888887', '773890007@qq.com', '', 'upload/shangjia_shangpuzhaopian7.jpg', '商家介绍7', 200);
INSERT INTO `shangjia` VALUES (28, '2024-03-24 13:38:01', '商家号8', '123456', '商家名称8', '商家地址8', '13823888888', '773890008@qq.com', '', 'upload/shangjia_shangpuzhaopian8.jpg', '商家介绍8', 200);
...
CREATE TABLE `shangpinxinxi`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `shangpinmingcheng` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '周边名称',
  `shangpinzhonglei` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '周边种类',
  `shangpintupian` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '周边图片',
  `shangpinxiangqing` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '周边详情',
  ...
  `storeupnum` int NULL DEFAULT 0 COMMENT '收藏数',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 49 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '周边信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of shangpinxinxi
-- ----------------------------
INSERT INTO `shangpinxinxi` VALUES (41, '2024-03-24 13:38:01', '周边名称1', '周边种类1', 'upload/shangpinxinxi_shangpintupian1.jpg,upload/shangpinxinxi_shangpintupian2.jpg,upload/shangpinxinxi_shangpintupian3.jpg', '周边详情1', '商家号1', '商家名称1', '联系电话1', '商家地址1', 1, 0, 99.9, 1);
INSERT INTO `shangpinxinxi` VALUES (42, '2024-03-24 13:38:01', '周边名称2', '周边种类2', 'upload/shangpinxinxi_shangpintupian2.jpg,upload/shangpinxinxi_shangpintupian3.jpg,upload/shangpinxinxi_shangpintupian4.jpg', '周边详情2', '商家号2', '商家名称2', '联系电话2', '商家地址2', 2, 0, 99.9, 2);
INSERT INTO `shangpinxinxi` VALUES (43, '2024-03-24 13:38:01', '周边名称3', '周边种类3', 'upload/shangpinxinxi_shangpintupian3.jpg,upload/shangpinxinxi_shangpintupian4.jpg,upload/shangpinxinxi_shangpintupian5.jpg', '周边详情3', '商家号3', '商家名称3', '联系电话3', '商家地址3', 3, 0, 99.9, 3);
INSERT INTO `shangpinxinxi` VALUES (44, '2024-03-24 13:38:01', '周边名称4', '周边种类4', 'upload/shangpinxinxi_shangpintupian4.jpg,upload/shangpinxinxi_shangpintupian5.jpg,upload/shangpinxinxi_shangpintupian6.jpg', '周边详情4', '商家号4', '商家名称4', '联系电话4', '商家地址4', 4, 0, 99.9, 4);
INSERT INTO `shangpinxinxi` VALUES (45, '2024-03-24 13:38:01', '周边名称5', '周边种类5', 'upload/shangpinxinxi_shangpintupian5.jpg,upload/shangpinxinxi_shangpintupian6.jpg,upload/shangpinxinxi_shangpintupian7.jpg', '周边详情5', '商家号5', '商家名称5', '联系电话5', '商家地址5', 5, 0, 99.9, 5);
INSERT INTO `shangpinxinxi` VALUES (46, '2024-03-24 13:38:01', '周边名称6', '周边种类6', 'upload/shangpinxinxi_shangpintupian6.jpg,upload/shangpinxinxi_shangpintupian7.jpg,upload/shangpinxinxi_shangpintupian8.jpg', '周边详情6', '商家号6', '商家名称6', '联系电话6', '商家地址6', 6, 0, 99.9, 6);
INSERT INTO `shangpinxinxi` VALUES (47, '2024-03-24 13:38:01', '周边名称7', '周边种类7', 'upload/shangpinxinxi_shangpintupian7.jpg,upload/shangpinxinxi_shangpintupian8.jpg,upload/shangpinxinxi_shangpintupian9.jpg', '周边详情7', '商家号7', '商家名称7', '联系电话7', '商家地址7', 7, 0, 99.9, 7);
INSERT INTO `shangpinxinxi` VALUES (48, '2024-03-24 13:38:01', '周边名称8', '周边种类8', 'upload/shangpinxinxi_shangpintupian8.jpg,upload/shangpinxinxi_shangpintupian9.jpg,upload/shangpinxinxi_shangpintupian10.jpg', '周边详情8', '商家号8', '商家名称8', '联系电话8', '商家地址8', 9, 0, 99.9, 8);
...
) ENGINE = InnoDB AUTO_INCREMENT = 39 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '周边种类' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of shangpinzhonglei
-- ----------------------------
INSERT INTO `shangpinzhonglei` VALUES (31, '2024-03-24 13:38:01', '周边种类1', 'upload/shangpinzhonglei_image1.jpg,upload/shangpinzhonglei_image2.jpg,upload/shangpinzhonglei_image3.jpg');
INSERT INTO `shangpinzhonglei` VALUES (32, '2024-03-24 13:38:01', '周边种类2', 'upload/shangpinzhonglei_image2.jpg,upload/shangpinzhonglei_image3.jpg,upload/shangpinzhonglei_image4.jpg');
INSERT INTO `shangpinzhonglei` VALUES (33, '2024-03-24 13:38:01', '周边种类3', 'upload/shangpinzhonglei_image3.jpg,upload/shangpinzhonglei_image4.jpg,upload/shangpinzhonglei_image5.jpg');
INSERT INTO `shangpinzhonglei` VALUES (34, '2024-03-24 13:38:01', '周边种类4', 'upload/shangpinzhonglei_image4.jpg,upload/shangpinzhonglei_image5.jpg,upload/shangpinzhonglei_image6.jpg');
INSERT INTO `shangpinzhonglei` VALUES (35, '2024-03-24 13:38:01', '周边种类5', 'upload/shangpinzhonglei_image5.jpg,upload/shangpinzhonglei_image6.jpg,upload/shangpinzhonglei_image7.jpg');
INSERT INTO `shangpinzhonglei` VALUES (36, '2024-03-24 13:38:01', '周边种类6', 'upload/shangpinzhonglei_image6.jpg,upload/shangpinzhonglei_image7.jpg,upload/shangpinzhonglei_image8.jpg');
INSERT INTO `shangpinzhonglei` VALUES (37, '2024-03-24 13:38:01', '周边种类7', 'upload/shangpinzhonglei_image7.jpg,upload/shangpinzhonglei_image8.jpg,upload/shangpinzhonglei_image9.jpg');
INSERT INTO `shangpinzhonglei` VALUES (38, '2024-03-24 13:38:01', '周边种类8', 'upload/shangpinzhonglei_image8.jpg,upload/shangpinzhonglei_image9.jpg,upload/shangpinzhonglei_image10.jpg');
...
CREATE TABLE `storeup`  (
  ...
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `userid` bigint NOT NULL COMMENT '用户id',
  `refid` bigint NULL DEFAULT NULL COMMENT '周边id',
...
-- Records of token
-- ----------------------------
INSERT INTO `token` VALUES (1, 11, '用户账号1', 'yonghu', '用户', 'y4w8jyoxypxng8g250vhmgzbi70nccyj', '2024-03-24 13:48:32', '2024-03-24 14:48:32');
INSERT INTO `token` VALUES (2, 1, 'admin', 'users', '管理员', '6p6pauoi83xy8sufvf8spttdkef7e8ep', '2024-03-24 13:53:28', '2026-03-13 20:36:42');
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES (1, 'admin', 'admin', 'upload/image1.jpg', '管理员', '2024-03-24 13:38:01');
...
-- Records of yonghu
-- ----------------------------
INSERT INTO `yonghu` VALUES (11, '2024-03-24 13:38:01', '用户账号1', '123456', '用户姓名1', '男', 1, 'upload/yonghu_touxiang1.jpg', 200);
INSERT INTO `yonghu` VALUES (12, '2024-03-24 13:38:01', '用户账号2', '123456', '用户姓名2', '男', 2, 'upload/yonghu_touxiang2.jpg', 200);
INSERT INTO `yonghu` VALUES (13, '2024-03-24 13:38:01', '用户账号3', '123456', '用户姓名3', '男', 3, 'upload/yonghu_touxiang3.jpg', 200);
INSERT INTO `yonghu` VALUES (14, '2024-03-24 13:38:01', '用户账号4', '123456', '用户姓名4', '男', 4, 'upload/yonghu_touxiang4.jpg', 200);
INSERT INTO `yonghu` VALUES (15, '2024-03-24 13:38:01', '用户账号5', '123456', '用户姓名5', '男', 5, 'upload/yonghu_touxiang5.jpg', 200);
INSERT INTO `yonghu` VALUES (16, '2024-03-24 13:38:01', '用户账号6', '123456', '用户姓名6', '男', 6, 'upload/yonghu_touxiang6.jpg', 200);
INSERT INTO `yonghu` VALUES (17, '2024-03-24 13:38:01', '用户账号7', '123456', '用户姓名7', '男', 7, 'upload/yonghu_touxiang7.jpg', 200);
INSERT INTO `yonghu` VALUES (18, '2024-03-24 13:38:01', '用户账号8', '123456', '用户姓名8', '男', 8, 'upload/yonghu_touxiang8.jpg', 200);
